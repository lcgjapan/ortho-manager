...
TRANSLATIONS = {
    ...
    "tools.web_maps.name": {
        "ja": "背景地図・Web地図",
        "en": "Background / Web Maps",
        "zh": "背景地图・网络地图",
    },
    "tools.web_maps.note": {
        "ja": "背景地図をQGISへ追加し、現在の表示中心と縮尺をGoogleマップへ送ります。",
        "en": "Add background maps to QGIS and send the current center and scale to Google Maps.",
        "zh": "向QGIS添加背景地图，并将当前中心和比例尺发送到Google地图。",
    },
    "tools.web_maps.basemap_group": {
        "ja": "QGIS背景地図",
        "en": "QGIS Background Map",
        "zh": "QGIS背景地图",
    },
    "tools.web_maps.add_basemap": {
        "ja": "追加・表示",
        "en": "Add / Show",
        "zh": "添加・显示",
    },
    "tools.web_maps.basemap_note": {
        "ja": "追加した背景地図はレイヤ一覧の下にまとめます。別の背景地図を選ぶと表示を切り替えます。インターネット接続が必要です。",
        "en": "Added maps are grouped at the bottom of the layer tree. Selecting another background switches visibility. Internet access is required.",
        "zh": "添加的地图会集中在图层列表底部。选择其他背景地图时会切换显示。需要网络连接。",
    },
    "tools.web_maps.google_group": {
        "ja": "Googleマップ連携",
        "en": "Google Maps",
        "zh": "Google地图联动",
    },
    "tools.web_maps.open_google": {
        "ja": "現在の表示をGoogleマップで開く",
        "en": "Open Current View in Google Maps",
        "zh": "在Google地图中打开当前视图",
    },
    "tools.web_maps.new_tab": {
        "ja": "新しいタブ",
        "en": "New tab",
        "zh": "新标签页",
    },
    "tools.web_maps.reuse_tab": {
        "ja": "同じタブを更新",
        "en": "Reuse same tab",
        "zh": "更新同一标签页",
    },
    "tools.web_maps.chrome_note": {
        "ja": "「同じタブを更新」を使用する場合は、最初の1回だけChrome連携拡張を登録してください。",
        "en": "To use Reuse same tab, register the bundled Chrome extension once.",
        "zh": "使用“更新同一标签页”时，请仅在首次注册附带的Chrome扩展。",
    },
    "tools.web_maps.extension_folder": {
        "ja": "① 拡張フォルダを開く",
        "en": "1 Open Extension Folder",
        "zh": "① 打开扩展文件夹",
    },
    "tools.web_maps.chrome_settings": {
        "ja": "② Chromeを開く",
        "en": "2 Open Chrome",
        "zh": "② 打开Chrome",
    },
    "tools.web_maps.shortcut_note": {
        "ja": "QGIS標準のショートカット設定画面で、「現在の表示をGoogleマップで開く」にキーを割り当てます。設定しなくても、上のボタンから実行できます。",
        "en": "Use the standard QGIS shortcut settings to assign a key to Open the current view in Google Maps. You can still use the button above without assigning a shortcut.",
        "zh": "在QGIS标准快捷键设置中为“在Google地图中打开当前视图”分配按键。不设置快捷键也可以使用上方按钮执行。",
    },
    "tools.web_maps.shortcut_settings": {
        "ja": "QGISショートカット設定を開く",
        "en": "Open QGIS Shortcut Settings",
        "zh": "打开QGIS快捷键设置",
    },
    "tools.web_maps.shortcut_dialog_title": {
        "ja": "Googleマップを開くショートカット設定",
        "en": "Google Maps Shortcut Settings",
        "zh": "打开Google地图的快捷键设置",
    },
    "tools.web_maps.shortcut_title": {
        "ja": "Googleマップを開くショートカットキー",
        "en": "Keyboard shortcut for Google Maps",
        "zh": "打开Google地图的快捷键",
    },
    "tools.web_maps.chrome_title": {
        "ja": "Googleマップ「同じタブを更新」の設定",
        "en": "Google Maps reuse same tab setup",
        "zh": "Google地图“更新同一标签页”设置",
    },
    "tools.web_maps.chrome_steps": {
        "ja": "④ Chromeのアドレス欄に貼り付けて、Enterを押す\n⑤ 右上の「デベロッパーモード」をONにする\n⑥「パッケージ化されていない拡張機能を読み込む」を押す\n⑦ ①で開いた「chrome_extension」フォルダを選択する\n\n※一度登録すれば、次回からこの設定は不要です。\n※「新しいタブ」を使用する場合、Chrome連携拡張は不要です。",
        "en": "4 Paste it into the Chrome address bar and press Enter.\n5 Turn on Developer mode at the top right.\n6 Click Load unpacked.\n7 Select the chrome_extension folder opened in step 1.\n\nYou only need to register it once. The Chrome extension is not required for New tab mode.",
        "zh": "④ 粘贴到Chrome地址栏，然后按Enter\n⑤ 开启右上角的“开发者模式”\n⑥ 点击“加载已解压的扩展程序”\n⑦ 选择步骤①中打开的“chrome_extension”文件夹\n\n注册一次后无需再次设置。使用“新标签页”时不需要Chrome扩展。",
    },
    "tools.web_maps.chrome_address": {
        "ja": "③ 下のアドレスを選択してコピーする（右クリック→コピー、または Ctrl+C）",
        "en": "3 Select and copy the address below (right-click and Copy, or Ctrl+C).",
        "zh": "③ 选择并复制下方地址（右键→复制，或按Ctrl+C）",
    },
    "tools.web_maps.basemap.seamlessphoto": {"ja": "地理院 全国最新写真", "en": "GSI Latest Seamless Photo", "zh": "地理院 全国最新影像"},
    "tools.web_maps.basemap.ort": {"ja": "地理院 基本図オルソ（2007年～・一部地域）", "en": "GSI Basic Map Ortho (limited areas)", "zh": "地理院 基本图正射影像（部分地区）"},
    "tools.web_maps.basemap.airphoto": {"ja": "地理院 簡易空中写真（2004年～・一部地域）", "en": "GSI Aerial Photo (limited areas)", "zh": "地理院 简易航空影像（部分地区）"},
    "tools.web_maps.basemap.std": {"ja": "地理院 標準地図", "en": "GSI Standard Map", "zh": "地理院 标准地图"},
    "tools.web_maps.basemap.pale": {"ja": "地理院 淡色地図", "en": "GSI Pale Map", "zh": "地理院 淡色地图"},
    "tools.web_maps.basemap.blank": {"ja": "地理院 白地図", "en": "GSI Blank Map", "zh": "地理院 空白地图"},
    "tools.web_maps.basemap.relief": {"ja": "地理院 色別標高図", "en": "GSI Colored Elevation", "zh": "地理院 分层设色高程图"},
    "tools.web_maps.basemap.hillshade": {"ja": "地理院 陰影起伏図", "en": "GSI Hillshade", "zh": "地理院 阴影起伏图"},
    "tools.web_maps.basemap.osm": {"ja": "OpenStreetMap", "en": "OpenStreetMap", "zh": "OpenStreetMap"},
    "tools.web_maps.basemap_existing": {"ja": "既存の背景地図へ切り替えました。", "en": "Switched to the existing background map.", "zh": "已切换到现有背景地图。"},
    "tools.web_maps.basemap_failed": {"ja": "背景地図レイヤを作成できませんでした。", "en": "Could not create the background map layer.", "zh": "无法创建背景地图图层。"},
    "tools.web_maps.basemap_added": {"ja": "背景地図を追加しました。", "en": "Background map added.", "zh": "已添加背景地图。"},
    "tools.web_maps.google_sent": {"ja": "現在の表示位置をGoogleマップへ送りました。", "en": "Sent the current view to Google Maps.", "zh": "已将当前视图发送到Google地图。"},
    "tools.web_maps.google_failed": {"ja": "Googleマップを開けませんでした。", "en": "Could not open Google Maps.", "zh": "无法打开Google地图。"},
    "tools.web_maps.chrome_open_failed": {"ja": "Chromeで chrome://extensions/ を開いてください。", "en": "Open chrome://extensions/ in Chrome.", "zh": "请在Chrome中打开 chrome://extensions/。"},
